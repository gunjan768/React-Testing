...
// test.only(......) will run this test only and skip others.
// test.skip(......) will skip this particular test
...
test("handles error for scoops and toppings routes", async () => {
    ...
    // waitFor() will wait for all the "alerts" abd then it will execute "expect(alerts).toHaveLength(2)"
    await waitFor(async () => {
